...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.60in" margin-right="0.60in" page-height="14in" page-width="8.50in" margin-top="0.6in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.21in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.21in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.60in" margin-right="0.60in" page-height="14in" page-width="8.50in" margin-top="0.6in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.21in" margin-bottom="0.49in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.21in"/>
			</fo:simple-page-master>
	...
	<xsl:variable name="altova:nodeCssClasses">
		<Class sFile="default.css" sSelector="bg-color-1">
			<Styles background-color="#393C3E"/>
		</Class>
		<Class sFile="default.css" sSelector="bg-color-2">
			<Styles background-color="#E2E2E2"/>
		</Class>
		<Class sFile="default.css" sSelector="bg-color-4">
			<Styles background-color="#4A90E2"/>
		</Class>
		<Class sFile="default.css" sSelector="border-left-1">
			<Styles border-left-color="#A0A2A2" border-left-style="solid" border-left-width="1px" padding="0"/>
		</Class>
		<Class sFile="default.css" sSelector="border-right-1">
			<Styles padding="0"/>
		</Class>
		<Class sFile="default.css" sSelector="border-type-1">
			<Styles border="#A0A2A2" border-style="solid" border-width="1px"/>
		</Class>
		<Class sFile="default.css" sSelector="cell-type-1">
			<Styles background-color="#E2E2E2" border="#A0A2A2" border-style="solid" border-width="1px"/>
		</Class>
		<Class sFile="default.css" sSelector="cell-type-1-alt">
			<Styles border="#A0A2A2" border-style="solid" border-width="1px"/>
		</Class>
		<Class sFile="default.css" sSelector="field-mini-1">
			<Styles color="#3C3D3E" font-size="5pt"/>
		</Class>
		<Class sFile="default.css" sSelector="field-title-1">
			<Styles color="#3C3D3E" font-size="8pt"/>
		</Class>
	</xsl:variable>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xap/1.0/">
								<xmp:CreatorTool>Altova StyleVision Enterprise Edition 2013 sp1 (http://www.altova.com)</xmp:CreatorTool>
							</rdf:Description>
						</rdf:RDF>
					</x:xmpmeta>
				</fo:declarations>
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
					<fo:static-content flow-name="odd-page-header">
						<fo:block-container overflow="hidden" display-align="before">
							<fo:block font-family="Soberana Sans" font-size="9pt">
								<xsl:variable name="altova:table">
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row background-color="#393C3E">
												<fo:table-cell padding="0.196850394in" display-align="center">
													<fo:block-container overflow="hidden">
														<fo:block text-align="left">
															<xsl:variable name="altova:sUrlOrData" select="&apos;logo-gob-mx-header.svg&apos;"/>
															...
															<fo:external-graphic content-height="0.196850394in" scaling="non-uniform">
																...
																<xsl:attribute name="src">
																	...
																	<xsl:call-template name="altova:double-backslash">
																		<xsl:with-param name="text">
																			<xsl:value-of select="string(&apos;logo-gob-mx-header.svg&apos;)"/>
																		</xsl:with-param>
																		<xsl:with-param name="text-length">
																			<xsl:value-of select="string-length(string(&apos;logo-gob-mx-header.svg&apos;))"/>
																		</xsl:with-param>
																	</xsl:call-template>
																	<xsl:text>)</xsl:text>
																</xsl:attribute>
											...
											<fo:table-row background-color="#E2E2E2" border="#A0A2A2" border-style="solid" border-width="0.01in">
												<fo:table-cell padding="0.196850394in" display-align="center">
													<fo:block-container overflow="hidden">
						...
						<fo:block font-family="Soberana Sans" font-size="9pt">
							<xsl:variable name="altova:table">
								<fo:table table-layout="fixed" width="100%" border-spacing="0">
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell height="0.590551181in" padding="0" display-align="center">
												<fo:block-container overflow="hidden">
													<fo:block text-align="center">
														<fo:inline>
							...
							<xsl:for-each select="$XML">
								<xsl:for-each select="Result">
									<xsl:for-each select="Formato">
										<xsl:variable name="altova:table">
											<fo:table table-layout="fixed" width="100%" border-spacing="0">
												<fo:table-column column-width="3.543in"/>
												<fo:table-column column-width="0.197in"/>
												<fo:table-column column-width="3.543in"/>
													...
													<fo:table-row>
														<fo:table-cell padding="0" display-align="center">
															<fo:block-container overflow="hidden">
																<fo:block text-align="left">
																	<xsl:variable name="altova:table">
																		<fo:table border="#A0A2A2" border-style="solid" border-width="0.01in" table-layout="fixed" width="100%" border-spacing="0">
																			<fo:table-column column-width="3.543in"/>
																			<xsl:variable name="altova:CurrContextGrid_4" select="."/>
																			<xsl:variable name="altova:ColumnData"/>
																			<fo:table-body start-indent="0pt">
																				<fo:table-row height="0.275590551in">
																					<fo:table-cell background-color="#E2E2E2" border="#A0A2A2" border-style="solid" border-width="0.01in" padding="0" display-align="center">
																						<fo:block-container overflow="hidden">
																							<fo:block text-align="center">
																								<fo:inline color="#3C3D3E" font-size="8pt">
																								...
																								<xsl:variable name="altova:table">
																									<fo:table table-layout="fixed" width="100%" border-spacing="0">
																										...
																										<fo:table-body padding="0" start-indent="0pt">
																											<fo:table-row>
																												<fo:table-cell border="0" border-right-color="#A0A2A2" border-right-style="solid" border-right-width="thin" line-height="0.11in" padding="0" padding-top="0.06in" display-align="center">
																													<fo:block-container overflow="hidden">
																														<fo:block text-align="center">
																															...
																															<altova:line-break/>
																															<fo:inline color="#3C3D3E" font-size="5pt" width="33%">
																																<xsl:text>DD</xsl:text>
																															</fo:inline>
																														</fo:block>
																													</fo:block-container>
																												</fo:table-cell>
																												<fo:table-cell border="0" line-height="0.11in" padding="0" padding-top="0.06in" display-align="after">
																													<fo:block-container overflow="hidden">
																														<fo:block text-align="center">
																															...
																															<altova:line-break/>
																															<fo:inline color="#3C3D3E" font-size="5pt" width="34%">
																																<xsl:text>MM</xsl:text>
																															</fo:inline>
																														</fo:block>
																													</fo:block-container>
																												</fo:table-cell>
																												<fo:table-cell border="0" border-left-color="#A0A2A2" border-left-style="solid" border-left-width="thin" line-height="0.11in" padding="0" padding-top="0.06in" display-align="center">
																													<fo:block-container overflow="hidden">
																														<fo:block text-align="center">
							...
							<xsl:variable name="altova:table">
								<fo:table table-layout="fixed" width="100%" border-spacing="0">
									...
									<xsl:variable name="altova:ColumnData"/>
									<fo:table-body start-indent="0pt">
										<fo:table-row height="0.196850394in">
											<fo:table-cell padding="0" display-align="center">
												<fo:block-container overflow="hidden">
													<fo:block text-align="left"/>
												</fo:block-container>
							...
							<xsl:variable name="altova:table">
								<fo:table table-layout="fixed" width="100%" border-spacing="0">
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row height="0.196850394in">
											<fo:table-cell background-color="#E2E2E2" border="#A0A2A2" border-style="solid" border-width="0.01in" padding-bottom="0.0984252in" padding-top="0.0984252in" padding="0" display-align="center">
												<fo:block-container overflow="hidden">
													<fo:block text-align="center">
														<fo:inline>
																		...
																		<xsl:variable name="altova:table">
																			<fo:table table-layout="fixed" width="100%" border-spacing="0">
																				...
																				<fo:table-body start-indent="0pt">
																					...
																					<fo:table-row height="0.275590551in">
																						<fo:table-cell border="#A0A2A2" border-style="solid" border-width="0.01in" padding-left="0.0984252in" padding-top="0.03in" padding="0" display-align="center">
																							<fo:block-container overflow="hidden">
																								<fo:block text-align="left">
																									<fo:inline color="#3C3D3E" font-size="8pt">
																					...
																					<fo:table-row height="0.275590551in">
																						<fo:table-cell border="#A0A2A2" border-style="solid" border-width="0.01in" padding-left="0.0984252in" padding="0" display-align="center">
																							<fo:block-container overflow="hidden">
																								<fo:block text-align="left">
																									<fo:inline color="#3C3D3E" font-size="8pt">
																					...
																					<fo:table-row border="#A0A2A2" border-style="solid" border-width="0.01in" height="0.275590551in">
																						<fo:table-cell border="#A0A2A2" border-style="solid" border-width="0.01in" padding-left="0.0984252in" padding="0" display-align="center">
																							<fo:block-container overflow="hidden">
																								<fo:block text-align="left">
																									<fo:inline color="#3C3D3E" font-size="8pt">
																								...
																								<fo:block text-align="left">
																									<xsl:variable name="altova:table">
																										<fo:table table-layout="fixed" width="100%" border-spacing="0">
																											...
																											<xsl:variable name="altova:ColumnData"/>
																											<fo:table-body padding="0" start-indent="0pt">
																												<fo:table-row height="0.14in">
																													<fo:table-cell border="0" color="#3C3D3E" font-size="8pt" padding="0" display-align="center">
																														<fo:block-container overflow="hidden">
																															<fo:block text-align="left">
																																<fo:inline color="#3C3D3E" font-size="8pt">
																					...
																					<fo:table-row height="0.275590551in">
																						<fo:table-cell border="#A0A2A2" border-style="solid" border-width="0.01in" height="0.393701in" padding="0.0984252in" display-align="before">
																							<fo:block-container overflow="hidden">
																								<fo:block text-align="left">
																									<fo:inline color="#3C3D3E" font-size="8pt">
														...
														<xsl:variable name="altova:table">
															<fo:table table-layout="fixed" width="100%" border-spacing="0">
																...
																<fo:table-body start-indent="0pt">
																	...
																	<fo:table-row border="#A0A2A2" border-style="solid" border-width="0.01in" height="0.275590551in">
																		<fo:table-cell padding-top="0.03in" padding="0" display-align="after">
																			<fo:block-container overflow="hidden">
																				<fo:block text-align="left">
																					<xsl:variable name="altova:table">
																						<fo:table table-layout="fixed" width="100%" border-spacing="0">
																							<fo:table-column column-width="proportional-column-width(1)"/>
																							<fo:table-column column-width="0.827in"/>
																							<fo:table-column column-width="1.600in"/>
																							<xsl:variable name="altova:CurrContextGrid_15" select="."/>
																							<xsl:variable name="altova:ColumnData"/>
																							<fo:table-body padding="0" start-indent="0pt">
																								<fo:table-row height="0.14in">
																									<fo:table-cell border="0" color="#3C3D3E" font-size="8pt" padding-left="0.0984252in" padding="0" display-align="center">
																										<fo:block-container overflow="hidden">
																											<fo:block text-align="left">
																												<fo:inline>
																									...
																									<fo:table-cell border="0" border-left-color="#A0A2A2" border-left-style="solid" border-left-width="0.01in" padding="0" display-align="after">
																										<fo:block-container overflow="hidden">
																											<fo:block text-align="left">
																												<xsl:variable name="altova:table">
																													<fo:table margin="0" padding="0" display-align="after" table-layout="fixed" width="100%" border-spacing="0">
																														<fo:table-column column-width="0.138in"/>
																														<fo:table-column column-width="0.138in"/>
																														<fo:table-column column-width="0.138in"/>
																														<fo:table-column column-width="0.138in"/>
																														<fo:table-column column-width="0.138in"/>
																														...
																														<fo:table-body start-indent="0pt">
																															<fo:table-row>
																																<fo:table-cell height="0.07in" padding="0" display-align="after">
																																	<fo:block-container overflow="hidden">
																																		<fo:block text-align="left"/>
																																	</fo:block-container>
																																</fo:table-cell>
																																<fo:table-cell border-left-color="#A0A2A2" border-left-style="solid" border-left-width="0.01in" height="0.07in" padding="0" display-align="after">
																																	<fo:block-container overflow="hidden">
																																		<fo:block text-align="left"/>
																																	</fo:block-container>
																																</fo:table-cell>
